...
<body>
  ...
  // resize=window + fullscreen=true fill the browser viewport
  const dcvURL    = dcvBase + '/?sessionId=console&resize=window&fullscreen=true' + (AUTH_TOKEN ? '&authToken=' + AUTH_TOKEN : '');
