...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "PV_PID=$!",
      "# After DCV resizes display to browser viewport, re-maximize the main window",
      ...
      "      xprop -id $w -format _NET_WM_STATE 32a -set _NET_WM_STATE '_NET_WM_STATE_MAXIMIZED_VERT,_NET_WM_STATE_MAXIMIZED_HORZ' 2>/dev/null",
      "    done",
      "    break",
      "  fi",
      "done &",
